...
%   X = GEN_TEST_BP_SIGNAL(DUR,DT,FMIN,FMAX) returns a signal DUR seconds
%   long uniformly sampled at intervals DT. The generated signal's 
%   frequency components are no lower than FMIN Hz and no higher than FMAX Hz.
%
%   X = GEN_TEST_BP_SIGNAL(DUR,DT,FMIN,FMAX,NP) adds Gaussian white noise
...
%   Author(s): Eftychios A. Pnevmatikakis (based on gen_test_signal written
%       by Lev Givon)
