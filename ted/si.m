...
%   a rational approximation. This implementation is faster than 
...
if x == 0,
    si = 0.0;
elseif x <= 1.0,
    si = (((((3.1e-7)*x2-2.834e-5)*x2+1.66667e-3)*x2-5.555556e-2)*x2+1.0)*x;
else
    fx = ((((x2+38.027264)*x2+265.187033)*x2+335.67732)*x2+38.102495)/ ...
         ((((x2+40.021433)*x2+322.624911)*x2+570.23628)*x2+ ...
          157.105423);
