...
%   iaf_decode_pop               - Population-based IAF time decoder that uses sinc kernels.
...
%   gammatone                    - Create a gammatone filter bank (for the sinc kernel demo).
...
%   G_block_IF                   - Compute part of reconstruction matrix for multiple 
%                                  IAF neuron decoder.
...
%   psi                          - Compute signal reconstruction function needed by 
%                                  spline interpolation decoders.
